        ...
        <div class="par parsys"><div class="parbase global-title section">
            ...
            <div class="request-a-test-drive section">
                <script type="text/javascript">
                    ...
                    } else if ($(".trim_list li").find(".r_on").parent().find("input").attr("trimcode")){
                    isfalse = true;
                    $scope.selectedTrim = $(".trim_list li").find(".r_on").parent().find("input").attr("trimcode");
                    $scope.selectedTrimName = $(".trim_list li").find(".r_on").parent().find("input").attr("trimName");
                    $($(".trim_list li").find(".r_on")).each(function(idx){
                    $scope.SelectedCarTrim[idx] = $(this).parent().find("input").attr("trimName");
                    var idxCar = $(this).parent().find("input").attr("id").split("_")[1];
                    var idxTrim = $(this).parent().find("input").attr("id").split("_")[2];
                    $scope.SelectedCarTrimCode[idx] = $scope.cars[idxCar].carTrimCode[idxTrim];
                    });
                    _vehicle_trim_data_ = $scope.SelectedCarTrim;
                    _vehicle_trim_code_ = $scope.SelectedCarTrimCode;
                    ...
                    _satellite.track('testdrive_trim');
                    break;
                    case "3":
                    ...
                    _satellite.track('testdrive_dealer');
                    }
                    break;
                    case "4":
                            userdataInfoSubmit();
                    ...
                    method : "POST"
                            ...
                            , url : "/api/kia_global/base/rq03/reqTestDrive.insertReqTestDrive"
                    };
                ...
                <div class="content_detail" ng-controller="requestatestdrive.steps" ng-init="init()">
                    ...
                    <div class="inner request_testdrive" ng-show="step == 1">
                            ...
                            <li class="stepWrap on">
                                <div class="stepbar bar01">
                                    ...
                                    <div class="txt">
                                        ...
                                        <span class="ex">Please select vehicle.</span>
                                    </div>
                                </div>
                                <div class="stepCon">
                    ...
                    <div class="inner request_testdrive" ng-show="step == 2">
                        <ol class="stepType01 driveStep">
                            ...
                            <li class="stepWrap on">
                                ...
                                <div class="stepCon">
                                    <h5 class="bl_type1" ng-repeat-start="car in cars">{{car.carName}}</h5>
                            ...
                            <li class="stepWrap">
                                <div class="stepbar bar03">
                                    <strong class="num"><em>03</em></strong>
                                    <div class="txt">
                                        <strong>Enter Zipcode(Postcode)</strong>
                                    </div>
                                </div>
                            </li>
                            <li class="stepWrap">
                    ...
                    <div class="inner request_testdrive" ng-show="step == 3">
                        <ol class="stepType01 driveStep">
                            <li class="stepWrap paston">
                                <div class="stepbar bar01">
                                    <strong class="num"><em>01</em></strong>
                    ...
                    <div class="inner request_testdrive" ng-show="step == 4">
                        <ol class="stepType01 driveStep">
                            <li class="stepWrap paston">
                                <div class="stepbar bar01">
                                    <strong class="num"><em>01</em></strong>
                            ...
                            <li class="stepWrap on">
                                ...
                                <div class="stepCon">
                                    <div class="parsys person-info"><div class="userdata-keyin section">
                                            ...
                                            <form name="datainfo-comp-form" method="POST" action="">
                                                ...
                                                <ul class="info_tbl">
                                                    ...
                                                    <li class="info_tr">
                                                        <div class="info_th">Zipcode / City <em class="ess">* <span class="hidden">Is required information.</span></em></div>
                                                        <div class="info_td">
                                                            <span class="form_wrp only"><input type="text" name="city" id="city" class="input_box" maxlength="100" placeholder="Zipcode / City" title="City"></span>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="info_tr">
                                                        <div class="info_th">Preferred date <em class="ess">* <span class="hidden">Is required information.</span></em></div>
                                                        <div class="info_td">
                                                            <div class="form_area">
                                                                <span class="form_date"><input type="text" name="pdate" id="pdate" class="input_box" placeholder="Preferred date" title="Preferred date"> <a href="#" class="cmm_spr spr_calendar">Calendar </a></span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="info_tr">
                                                        <div class="info_th">Preferred time <em class="ess">* <span class="hidden">Is required information.</span></em></div>
                                                        <div class="info_td">
                                                            <div class="form_area">
                                                                <span class="form_wrp">
                                                                    <span class="sel_box inp_sel">
                                                                        <select class="form_select" name="ptime" id="ptime" title="Preferred time">
                                            ...
                                            <script type="text/javascript">
                                                                    ...
                                                                    ,
                                                                            ...
                                                                            , city : {
                                                                            required : "Por favor ingresa tu código postal, ciudad."
                                                                            }
                                                                            ...
                                                                            , pdate : {
                                                                            required : "Please enter a Preferred Date."
                                                                            }
                                    ...
                                    <div class="step_ctrl">
                                        ...
                                        <a href="#" class="btnMedium btnType1" ng-click="validation('4', '5', true)">
                                            <span class="btnIcon arrow_r">Submit</span>
                                        </a>
                                    </div>
                                    <div class="note_area">
                            ...
                            <div class="parsys person-info-view"><div class="userdata-view section">
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        "dummy" : ""
                                                ...
                                                , "reqCity" : _userdata_view_scope_.city
                                    ...
                                    <table class="table_type2" ng-controller="userdata.view" id="userdata.view.comp">
                                        <caption>Kia Test Drive | Kia Shopping Tools | Kia Motors Global result report</caption>
                                        <colgroup>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th class="tleft">Zipcode / City</th>
                                                <td class="tleft">{{city}}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <th class="tleft">Preferred date</th>
                                                <td class="tleft">{{pdate| parseDate | date : 'MM-dd-yyyy'}}</td>
                                            </tr>



                                            <tr>
                                                <th class="tleft">Preferred time</th>
                                                <td class="tleft">{{ptime}}</td>
                                            </tr>
